...
const productSchema = z.object({
  ...
  description: z.string().min(1),
  price: z.number().positive(),
  video: z.string().url().optional(), // Lägg till video som ett valfritt fält
  slug: z.string().optional(),
});

export type ProductFormData = z.infer<typeof productSchema>; // Exportera ProductFormData typen
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                      <TextField
                        ...
                        inputProps={{ "data-cy": "product-video" }}
                        FormHelperTextProps={
                          {
                            "data-cy": "product-video-error",
                          } as FormHelperTextProps
                        }
                      />
                    </Grid>
